...
If neither is present (e.g. for ``manage.py check`` outside the orchestrator)
we fall back to SQLite + the in-memory cache.
"""
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "test-site-not-for-production-XXXXXXXXXXXXXXXXXXXXXX",
)
